...
public class HomeController extends WorkdaysProperties{
	...
	public String tester(){
		System.setProperty(ChromeDriverService.CHROME_DRIVER_EXE_PROPERTY, "/var/www/html/download/chromedriver.exe" /*"C:/久保さん/cloneproject/workdays/chromedriver.exe"*/);
